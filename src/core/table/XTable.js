...
class XTableStyleUI extends XTableUI {
...
class XFontStyleUI extends XTableStyleUI {
  ...
  drawFont() {
    ...
    const that = new this.constructor(table);
    const {
      scale, draw,
    } = this;
...
class XTableContentUI extends XFontStyleUI {
